...
public class TaskEdit extends StandardEditor<Task> {
    ...
    @Autowired
    private FileStorageUploadField subTaskUpload;
    @Autowired
    ...
    @Subscribe("subTaskUpload")
    public void onSubTaskUploadFileUploadSucceed(final SingleFileUploadField.FileUploadSucceedEvent event) throws IOException {
        UUID fileId = subTaskUpload.getFileId();
        if (fileId == null) {
            return;
        }
